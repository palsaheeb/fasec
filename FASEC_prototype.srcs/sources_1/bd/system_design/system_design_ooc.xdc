...
# of Vivado)
################################################################################
create_clock -name clk_aux_i_clk_p -period 10 [get_ports clk_aux_i_clk_p]
create_clock -name gtp_dedicated_clk_i_clk_p -period 10 [get_ports gtp_dedicated_clk_i_clk_p]
