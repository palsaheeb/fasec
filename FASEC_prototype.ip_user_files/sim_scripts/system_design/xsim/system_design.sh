...
#
# Generated by Vivado on Thu Dec 15 08:50:33 CET 2016
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L unisims_ver -L unimacro_ver -L secureip --snapshot system_design xil_defaultlib.system_design xil_defaultlib.glbl -log elaborate.log
}
