...
-- #TODO: check if AXI can use write-and read-channels simultaniously
-- #TODO: axi_rvalid and ax_bvalid will assert together, unwanted!
-------------------------------------------------------------------------------
-- Revisions  :
...
begin  -- architecture rtl
  ...
  -- WB addresses
  wb_adr_o(g_WB_AWIDTH-1 downto 0)               <= s_addr(g_WB_AWIDTH+ADDR_LSB-1 downto ADDR_LSB);
