    ...
    for i in g_num_slaves-1 downto 0 loop
      if c_layout(i)(7) = '1' then
        ...
        -- the base address must be aligned to the size
         ...
         report "Wishbone slave device #" & Integer'image(i) & " (" & f_trim(sdb_component.product.name) & ") sdb_component.addr_first (" & f_bits2string(sdb_component.addr_first) & ") is not aligned. This is not supported by the crossbar. Size=" & f_bits2string(std_logic_vector(size)) & " . End line."
         severity Failure;
