...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_wb_i2c_master
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_wb_i2c_master_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_wb_i2c_master
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_wb_i2c_master_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_wb_i2c_master
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_wb_i2c_master_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = fasec_hwtest_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = xadc_axis_fifo_adapter_0
END
